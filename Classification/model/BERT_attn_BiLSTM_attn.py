...
class Encoder(nn.Module):
    def __init__(self, classes_num, hidden_size=128, BERT_out_dropout=0.5, BiLSTM_dropout=0.1):
        ...
        self.linear_layer_attn_1 = Linear(768, 300)
        self.linear_layer_attn_2 = Linear(300, 1)
    ...
    def forward(self, x, mask):
        ...
        attn_scores = self.linear_layer_attn_2(T.tanh(self.linear_layer_attn_1(concated_layers)))
